...
package org.zoocode.jetbrains.plugin
...
import org.zoocode.jetbrains.core.ExtensionProcessManager
import org.zoocode.jetbrains.core.ExtensionSocketServer
...
class WecoderPluginService(private var currentProject: Project) : Disposable {
    ...
    companion object {
        // Debug mode switch
        @Volatile
        private var DEBUG_TYPE: DEBUG_MODE = org.zoocode.jetbrains.plugin.DEBUG_MODE.NONE
        ...
        init {
            try {
                ...
                val configStream: InputStream? = WecoderPluginService::class.java.getResourceAsStream("/org/zoocode/jetbrains/plugin/config/plugin.properties")
...
//                ServiceProxyRegistry.getInstance().initialize()
                ...
                if (DEBUG_TYPE == org.zoocode.jetbrains.plugin.DEBUG_MODE.ALL) {
    ...
    private fun cleanup() {
        try {
            ...
            if (DEBUG_TYPE == org.zoocode.jetbrains.plugin.DEBUG_MODE.NONE) {
                processManager.stop()
            }
        } catch (e: Exception) {
