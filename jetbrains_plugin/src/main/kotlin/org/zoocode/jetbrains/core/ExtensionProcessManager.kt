...
import org.zoocode.jetbrains.util.NodeVersionUtil
import org.zoocode.jetbrains.util.NodeVersion
...
//                "--trace-uncaught",
    ...
    fun findExtensionEntryFile(): String? {
        ...
        // Normal mode
        val resourcesPath = org.zoocode.jetbrains.util.PluginResourceUtil.getResourcePath(PLUGIN_ID, "$RUNTIME_DIR/$EXTENSION_ENTRY_FILE")
        if (resourcesPath != null) {
