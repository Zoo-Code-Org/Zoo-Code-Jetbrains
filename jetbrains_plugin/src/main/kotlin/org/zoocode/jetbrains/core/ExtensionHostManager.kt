...
import org.zoocode.jetbrains.ipc.NodeSocket
...
import org.zoocode.jetbrains.extensions.core.VsixManager.Companion.getBaseDirectory
...
class ExtensionHostManager : Disposable {
    ...
    private fun getExtensionPath(extensionConfig: ExtensionMetadata): String? {
        ...
        try {
            val pluginResourcePath = org.zoocode.jetbrains.util.PluginResourceUtil.getResourcePath(
                org.zoocode.jetbrains.util.PluginConstants.PLUGIN_ID, 
