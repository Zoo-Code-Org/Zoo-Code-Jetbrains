...
import org.zoocode.jetbrains.theme.ThemeManager.Companion.getThemeResourceDir
...
class VsixManager {
    ...
    private fun getPluginThemesDirectory(): File? {
        return try {
            ...
            val pluginThemesPath = org.zoocode.jetbrains.util.PluginResourceUtil.getResourcePath(
    ...
    fun getExtensionResourcePath(
        ...
        try {
            val pluginPath = org.zoocode.jetbrains.util.PluginResourceUtil.getResourcePath(
                org.zoocode.jetbrains.util.PluginConstants.PLUGIN_ID,
                codeDir
            )
