...
import com.roocode.jetbrains.extensions.core.ExtensionManager as GlobalExtensionManager
...
import com.roocode.jetbrains.extensions.core.VsixManager.Companion.getBaseDirectory
...
class ExtensionHostManager : Disposable {
    ...
    private fun createInitData(): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "environment" to mapOf(
                ...
                "globalStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".zoo-code", "globalStorage").toString()),
                "workspaceStorageHome" to uriFromPath(Paths.get(System.getProperty("user.home"),".zoo-code", "workspaceStorage").toString()),
    ...
    private fun getExtensionPath(extensionConfig: ExtensionMetadata): String? {
        ...
        try {
            val pluginResourcePath = com.roocode.jetbrains.util.PluginResourceUtil.getResourcePath(
                com.roocode.jetbrains.util.PluginConstants.PLUGIN_ID, 
